...
/*!
 ...
 Calling trackView: will also update this property before it sends a hit to
 Google Analytics. However, if you wish to update the current screen without
 sending a hit, set this property directly. The updated screen will be reflected
 in subsequent events and transactions.
 */
@property(nonatomic, copy) NSString *appScreen;

/*!
 The referrer URL for this tracker. Changing this value causes it to
 be sent with the next dispatch of tracking information.
 */
...
/*!
 Track an event. This call sends a hit to Google Analytics that includes the
 current screen, as set in the appScreen property.
...
/*!
 ...
 @param var A string representing a timing variable name, or `nil` if none.
