...
/*!
 ...
 will effectively become no-ops. When set to true, all outstanding hits will be
 deleted. The value of this flag will be persisted automatically by the SDK.
 Developers can optionally use this flag to implement an opt-out setting in the
 app to allows users to opt out of Google Analytics tracking.
...
/*!
 ...
 dispatch any outstanding hits for 5 seconds. It will then call the previously
 registered exception handler, if any. When set back to false, the previously
